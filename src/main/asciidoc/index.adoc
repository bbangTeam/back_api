...
include::{snippets}/pilgrimagetest/list/request-fields.adoc[]
...
include::{snippets}/breadstagramtest/list/request-fields.adoc[]
...
include::{snippets}/breadstagramtest/view/request-fields.adoc[]
...
include::{snippets}/commenttest/list/request-fields.adoc[]
